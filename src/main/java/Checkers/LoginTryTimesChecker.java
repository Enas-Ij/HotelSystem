...
public class LoginTryTimesChecker {
    ...
    /*checks if the user had 5 or wrong login try if so it blocks him/her for the until the session ends
    ...
    //increases the number of login try the user had and returns it
